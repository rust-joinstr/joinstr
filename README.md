...
The [Dart/Flutter bindings](./dart) are published as the `joinstr_flutter`
package. They wrap the blocking `joinstr::interface` API through
flutter_rust_bridge, and ship a minimal Android example app.
